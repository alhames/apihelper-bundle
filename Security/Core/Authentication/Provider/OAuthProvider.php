...
namespace Alhames\ApiHelperBundle\Security\Core\Authentication\Provider;
...
use Alhames\ApiHelperBundle\Security\Core\User\ServiceAccountAwareUserProviderInterface;
